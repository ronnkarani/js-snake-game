document.addEventListener('DOMContentLoaded', () => {
  const squares = document.querySelectorAll('.grid div') //select all the divs with class name of grid
  ...
  let direction = 1 //first time the snake will always move left
  let score = 0
  let speed = 0.9
  let intervalTime = 0
  let interval = 0
  ...
  function randomApple() {
    ...
    } while(squares[appleIndex].classList.contains('snake')) //making sure apples dont appear  on a div with the snake
